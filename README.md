...
The repository is a managed Python-adapter project for GWAY. `wire` is the canonical project name; the former `wireguard` name and its short `wg` form remain aliases for compatibility:
